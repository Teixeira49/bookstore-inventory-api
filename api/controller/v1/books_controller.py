...
@router.get("/books/all", tags=["Vistas de Libros"], responses={
...
# --------------------------------------------------------------------------------------------
@router.get("/books", tags=["CRUD de Libros"], responses={
    200: {"description": "Lista de libros encontrada exitosamente."},
    404: {"description": "No se encontraron libros."},
    500: {"description": "Error interno del servidor."}
})
...
@router.post("/books", tags=["CRUD de Libros"], responses={
...
# --------------------------------------------------------------------------------------------
@router.get("/books/search/all", tags=["Búsqueda e Inventario"], responses={
...
@router.get("/books/low-stock/all", tags=["Búsqueda e Inventario"], responses={
    200: {"description": "Libros encontrados exitosamente."},
    404: {"description": "No se encontraron libros con ese criterio."},
    500: {"description": "Error interno del servidor."}
})
...
@router.get("/books/search", tags=["Búsqueda e Inventario"], responses={
    200: {"description": "Libros encontrados exitosamente."},
    404: {"description": "No se encontraron libros con ese criterio."},
    500: {"description": "Error interno del servidor."}
})
...
@router.get("/books/low-stock", tags=["Búsqueda e Inventario"], responses={
    200: {"description": "Libros encontrados exitosamente."},
    404: {"description": "No se encontraron libros con ese criterio."},
    500: {"description": "Error interno del servidor."}
})
...
@router.get("/books/{id}", tags=["CRUD de Libros"], responses={
...
@router.put("/books/{id}", tags=["CRUD de Libros"], responses={
...
@router.delete("/books/{id}", tags=["CRUD de Libros"], responses={
...
# --------------------------------------------------------------------------------------------
@router.post("/books/{id}/calculate-price", tags=["Integraciones Externas"]) # la prueba decia que hiciera esto un post, pero lo veo mas como patch
